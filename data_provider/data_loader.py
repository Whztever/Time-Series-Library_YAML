...
class Dataset_Load(Dataset):
    ...
    def __read_data__(self):
        ...
        # print(cols)
        cols.remove(self.target)
        # 生成一个每15分钟间隔的日期范围，这里以2023年1月1日为起点，生成与df长度相同的日期序列
        date_range = pd.date_range(start='2021-01-01', periods=len(df_raw), freq='15min')
